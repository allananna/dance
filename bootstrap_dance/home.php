	...
	<div class="container">
		<div class="row">
            ...
            ?>
                ...
                <font  size='5' style="top:0px; float:right;">
                        <!--<?php 
                        ...
                        while(mysqli_fetch_array($res)>0){
			...
			<div class="col-sm-12">
                ...
                <div style="position:absolute; top:100px; left:100px; background-color:white; opacity:0.8; z-index:999">
                ...
                <header id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <div class="fill" style="background-image:url(images/11.jpg)">
                        ...
                        <div class="item">
                            ...
                            <div class="fill" style="background-image:url(images/13.jpg);"></div>
